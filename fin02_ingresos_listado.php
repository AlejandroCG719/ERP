...
<html lang="es-MX">
  ...
  <body class="">
      ...
      <div id="page-content">
        <div id='wrap'>
          <div id="page-heading">
            ...
            <h1><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Ingresos</h1>
            <div class="options">
              ...
              <div class="col-md-12">
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadIngresos()">
                      Listado de Ingresos
                    </h4>
                    <div class="options">
                      <a href="javascript:;"><i class="fa fa-cog"></i></a>
                      <a href="javascript:;" onclick="loadIngresos()"><i class="fa fa-refresh"></i></a>
    ...
    <script type='text/javascript' src='assets/js/pages/fin02_ingresos_listado.js'></script>
  </body>
</html>
