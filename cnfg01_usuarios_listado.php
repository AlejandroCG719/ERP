...
<html lang="es-MX">
  ...
  <body class="">
      ...
      <div id="page-content">
        <div id='wrap'>
          <div id="page-heading">
            ...
            <h1><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Usuarios</h1>
            <div class="options">
              <div class="btn-toolbar">
                ...
                <a href='cnfg01_usuarios_edicion.php' class="btn btn-default"><i class="fa fa-plus"></i><span class="hidden-sm"> Nuevo usuario</span></a>
              </div>
            </div>
          </div>
          <div class="container">
              ...
              <div class="col-md-12">
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadUsuarios()">
                      Listado de Usuarios
                    </h4>
                    <div class="options">
                      <a href="javascript:;"><i class="fa fa-cog"></i></a>
                      <a href="javascript:;" onclick="loadUsuarios()"><i class="fa fa-refresh"></i></a>
    ...
    <script type='text/javascript' src='assets/js/pages/cnfg01_usuarios_listado.js'></script>
  </body>
</html>
