                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <div class="input-daterange input-group datepicker">
                                <input type="text" class="input-small form-control" id="fecha_inicio" name="fecha_inicio" onchange="Dias()"/>
                                <span class="input-group-addon">al</span>
                                <input type="text" class="input-small form-control" id="fecha_fin" name="fecha_fin" onchange="Dias()" />
                              </div>
                            </div>
                    ...
                    <div class="panel-body collapse in">
                      ...
                      <div class="row borde">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              ...
                              <input type="hidden" id="sbd-0" name="sueldo_base_0" value="0"/>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-sm-6">
                              <input type="text" id="cuota_diaria-0" name="cuota_diaria-0" class="form-control" placeholder="Costo cuota diaria" disabled/>
                            </div>
                      ...
                      <div class="row borde">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="text" id="costo-unitario-0" class="form-control" placeholder="Costo unitario" title="Costo unitario del articulo" value="0" disabled/>
