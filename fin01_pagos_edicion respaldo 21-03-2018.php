                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <div class="input-group date">
                                <input type="text" class="form-control datepicker" name="fecha_solicitud" id="fecha_solicitud" value="<?= ($b == 1) ? $oDatos->getFechaSolicitud() : date("Y-m-d") ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="number" step="0.01" value="<?= $oDatos->getMonto() ?>" class="form-control sec-1" id="monto" name="monto" placeholder="Ingrese el monto" title="Ingrese el monto del pago" tabindex="2"  <?= ($b == 1) ? 'disabled' : 'required'; ?>>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="text" value="<?= $oDatos->getBeneficiario() ?>" class="form-control sec-1" id="beneficiario" name="beneficiario" maxlength="70" placeholder="Nombre del beneficiario" title="Ingrese el nombre del beneficiario" tabindex="7"  <?= ($b == 1) ? 'disabled' : 'required'; ?>/>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="hidden" id="id_cot" value="<?= $oDatos->getCotizacion() ?>" />
                              <select class="form-control sec-1" id="id_cotizacion" name="id_cotizacion" disabled>
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="hidden" value="<?= $oDatos->getPromocion() ?>" id="promo"/>
                              <select class="form-control" id="id_promocion" name="id_promocion" onchange="loadCotizaciones()" tabindex="3" <?= ($b == 1) ? 'disabled' : 'required'; ?>>
                                <option selected disabled>Seleccione una promocion*</option>
                              </select>
                            </div>
                            <a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Seleccione una promoción">
                              <span class="fa  fa-info-circle"></span>
                            </a>
                          </div>
                          <div class="form-group">
                  ...
                  <div <?php if($b==0){ echo 'hidden';}?>>
                    ...
                    <div class="panel-body collapse in">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="col-sm-3 control-label">Fecha de depósito*</label>
                            <div class="col-sm-6">
                              <div class="input-group date">
                                <input type="text" name="fecha_deposito" class="form-control datepicker sec-2" value="<?= $oDatos->getFechaDeposito() ?>" tabindex="9" <?= ($b == 0) ? 'disabled' : 'required'; ?>/>
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                              </div>
                            </div>
