                  ...
                  <div class="panel-body collapse in">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="puesto" name="puesto" value="<?= $oDatos->getPuesto() ?>" placeholder="Ingrese el puesto deseado" title="Ingrese el puesto deseado" tabindex="1" required/>
                        </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="sueldo_bruto" name="sueldo_bruto" value="<?= $oDatos->getSueldoBruto() ?>" placeholder="Sueldo bruto deseado" title="Sueldo bruto deseado" tabindex="2" required/>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="nombre" name="nombre" value="<?= $oDatos->getNombre() ?>" placeholder="Ingrese su Nombre(s)" title="Nombre del candidato" tabindex="3" required/>
                          </div>
                          <div class="col-sm-1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="app" name="app" value="<?= $oDatos->getApp() ?>" placeholder="Ingrese su Apellido Paterno" title="Ingrese su apellido paterno" tabindex="4" required/>
                          </div>
                          <div class="col-sm-1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="apm" name="apm" value="<?= $oDatos->getApm() ?>" placeholder="Ingrese su  Apellido Materno " title="Ingrese su apellido materno" tabindex="5" required/>
                          </div>
                          <div class="col-sm-1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="calle" name="calle" value="<?= $oDatos->getCalle() ?>" placeholder="Ingrese la Calle" title="Ingrese el nombre de la calle en donde vive" tabindex="12" required/>
                          </div>
                          <div class="col-sm-1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="colonia" name="colonia" value="<?= $oDatos->getColonia() ?>" placeholder="Colonia" title="Ingrese la colonia donde vive" tabindex="13" required/>
                          </div>
                          <div class="col-sm-1">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="cp" name="cp" value="<?= $oDatos->getCP() ?>" placeholder="Ingrese el código postal" title="Ingrese el código postal" tabindex="14" required/>
                          </div>
                          <div class="col-sm-1">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="talla" name="talla" value="<?= $oDatos->getTalla() ?>" placeholder="Ingrese su talla" title="Ingrese su talla" tabindex="27" required/>
                          </div>
                          <div class="col-sm-1">
                  ...
                  <div class="panel-body collapse in">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="enfermedades_cronicas" name="enfermedades_cronicas" value="<?= $oDatos->getEnfermedadesCronicas() ?>" placeholder="Enfermedades Crónicas" title="Enfermedades Crónicas" tabindex="30" required/>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="med_tratamiento" name="med_tratamiento" value="<?= $oDatos->getMedTratamientos() ?>" placeholder="Medicamentos o tratamientos" title="Medicamento o tratamiento" tabindex="31" required>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="op_quirurgicas" name="op_quirurgicas" value="<?= $oDatos->getOpQuirurgicas() ?>" placeholder="Operaciones Quirurjicas" title="Operaciones Quirurgicas" tabindex="32" required>
                        </div>
                        <div class="col-sm-1">
                          <a href="#" data-toggle="tooltip" data-placement="top" data-original-title="">
                            <span class="fa fa-info-circle"></span>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="alergias_padecimientos" name="alergias_padecimientos" value="<?= $oDatos->getAlergiasPadecimientos() ?>" placeholder="Alergia o Padecimiento" title="Alergia o Padecimiento" tabindex="33" required/>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <div class="input-group">
                            <input type="text" class="input-small form-control" id="contacto_emergencia" name="contacto_emergencia" value="<?= $oDatos->getContactoEmergencia() ?>" placeholder="Contacto de emergencia" title="Contacto de emergencia" tabindex="35" required>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="escuela" name="escuela" value="<?= $oDatos->getEscuela() ?>" placeholder="Ingrese el nombre de la escuela" title="Nombre del candidato" tabindex="37" required/>
                          </div>
                          <div class="col-sm-1">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="titulo" name="titulo" value="<?= $oDatos->getTitulo() ?>" placeholder="Ingrese el titulo obtenido" title="Ingrese el titulo obtenido" tabindex="39" required/>
                          </div>
                          <div class="col-sm-1">
                  ...
                  <div class="panel-body collapse in">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="software" name="software" value="<?= $oDatos->getSoftware() ?>" placeholder="Ingrese el software que maneja" title="Ingrese el software que maneja" tabindex="40" required/>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control" id="nivel_software" name="nivel_software" title="Seleccione el nivel de manejo" tabindex="42" required>
                            <option selected disabled>Seleccione una opción</option>
                            <option value="1" <?= ($oDatos->getNivelSoftware() == 1) ? "selected" : "" ?>>Basico</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control" id="tipo_smartphone" name="tipo_smartphone" title="Seleccione una opción" tabindex="41" required>
                            ...
                            <option value="3" <?= ($oDatos->getTipoSmartphone() == 3) ? "selected" : "" ?>>IOS</option>
                          </select>
                        </div>
                        <div class="col-sm-1">
                          <a href="#" data-toggle="tooltip" data-placement="top" data-original-title="">
                  ...
                  <div class="panel-body collapse in">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="referencia_nombre_1" name="referencia_nombre_1" value="<?= $oDatos->getRefNom1() ?>" placeholder="Ingrese Nombre" title="Ingrese Nombre" tabindex="43" required/>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="parentesco_1" name="parentesco_1" value="<?= $oDatos->getParentesco1() ?>" placeholder="Ingrese su parentesco" title="Ingrese el código postal" tabindex="45" required/>
                        </div>
                        <div class="col-sm-1">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Nombre*</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="referencia_nombre_2" name="referencia_nombre_2" value="<?= $oDatos->getRefNom2() ?>" placeholder="Ingrese Nombre" title="Ingrese Nombre" tabindex="46" required/>
                        </div>
                        <div class="col-sm-1">
                          <a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Ingrese el nombre">
                            <span class="fa fa-info-circle"></span>
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Parentesco*</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="parentesco_2" name="parentesco_2" value="<?= $oDatos->getParentesco2() ?>" placeholder="Ingrese su parentesco" title="Ingrese el código postal" tabindex="48" required/>
                        </div>
                        <div class="col-sm-1">
                          <a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Ingrese su parentesco">
                            <span class="fa fa-info-circle"></span>
                  ...
                  <div class="panel-body collapse in">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="eAnterior_empresa" name="eAnterior_empresa" value="<?= $oDatos->getEAnteriorEmpresa() ?>" placeholder="Ingrese nombre de la empresa" title="Ingrese nombre de la empresa" tabindex="49" required/>
                        </div>
                        <div class="col-sm-1">
                          <a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Nombre del candidato">
                            <span class="fa fa-info-circle"></span>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="eAnterior_puesto" name="eAnterior_puesto" value="<?= $oDatos->getEAnteriorPuesto() ?>" placeholder="Ingrese puesto" title="Ingrese puesto" tabindex="51" required/>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="eAnterior_jefe" name="eAnterior_jefe" value="<?= $oDatos->getEAnteriorJefe() ?>" placeholder="Ingrese nombre del jefe inmediato" title="Ingrese nombre del jefe inmediato" tabindex="52" required/>
                        </div>
                        <div class="col-sm-1">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="eAnterior_motivo_salida" name="eAnterior_motivo_salida" value="<?= $oDatos->getEAnteriorMotivoSalida() ?>" placeholder="Ingrese motivo de salida" title="Ingrese motivo de salida" tabindex="55" required/>
                        </div>
                        <div class="col-sm-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" id="eAnterior_puesto_jefe" name="eAnterior_puesto_jefe" value="<?= $oDatos->getEAnteriorPuestoJefe() ?>" placeholder="Ingrese nombre del jefe inmediato" title="Ingrese nombre del jefe inmediato" tabindex="56" required/>
                        </div>
                        <div class="col-sm-1">
                          <a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Ingrese nombre del jefe inmediato">
                            <span class="fa fa-info-circle"></span>
                    ...
                    <div class="col-md-12" id="seccion_cv">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <div class="fileinput fileinput-new" data-provides="fileinput"><input type="hidden" value="" name="cv">
                            <div class="input-group">
                              ...
                              <span class="input-group-addon btn btn-default btn-file">
                                ...
                                <input type="file" id="archivo" name="archivo" onchange="validarCV()" tabindex="57" required>
                              </span>
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-sm-offset-3">
                        <div class="btn-toolbar">
                          ...
                          <button type="button" class="btn-default btn" onclick="window.location = 'cot01_cotizaciones_listado.php'" tabindex="59">Cancelar</button>
                        </div>
                      </div>
                    </div>
                  </div>
