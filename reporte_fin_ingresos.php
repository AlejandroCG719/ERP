...
<page>
	<div style="margin-left:15px; margin-right:15px; padding-top:30px">
		...
		<h1 style="margin-top:40px; text-align:center">TOP MKT<br>INGRESOS </h1>
		<div >
			<?php
				$ingreso = "";
				$ingresos= "";
								...
								<table style='width:100%; padding-top:5px; '>
									";
										$subconsulta =
											'SELECT
											 ...
											 FROM
											  finanzas_ingresos
											 WHERE
											  finanzas_ingresos.id_cliente = '.$row["id"].'
										...
										$ingreso .= "
											<tr>
												<th>Evento</th>
												<th style='text-align:center;'>No. Fac</th>
											...
											$ingreso .="
												<tr>
												  ...
												  <td style='width:10%; text-align:center; vertical-align: middle'>".$row2["no_factura"]."</td>
													...
													<td style='width:15%; text-align:right; vertical-align: middle'>".number_format($row2["importe"], 2, '.', ',')."</td>
													<td style='width:15%; text-align:right; vertical-align: middle'>".number_format($row2["iva"], 2, '.', ',')."</td>
			...
			<table style="width:100%; padding-top:30px">
				<tr>
					<th style='width:60%; font-size: 18px'>Total Ingresos</th>
