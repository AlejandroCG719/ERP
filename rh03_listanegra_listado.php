...
<html lang="es-MX">
  ...
  <body class="">
        ...
        <div id='wrap'>
          <div id="page-heading">
            <ol class="breadcrumb">
              ...
              <li><a href="rh03_listanegra_listado.php"><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Lista Negra</a></li>
              <li class="active">Listado de Boletinados</li>
            </ol>
            <h1><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Boletinados</h1>
            <div class="options">
              <div class="btn-toolbar">
                ...
                <a href='rh03_listanegra_listado.php' class="btn btn-default"><i class="fa fa-plus"></i><span class="hidden-sm"> Nuevo Boletinado</span></a>
              </div>
            </div>
          </div>
          <div class="container">
              ...
              <div class="col-md-12">
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadBoletinados()">
                      Listado de Boletinados
                    </h4>
                    <div class="options">
                      <a href="javascript:;"><i class="fa fa-cog"></i></a>
                      <a href="javascript:;" onclick="loadBoletinados()"><i class="fa fa-refresh"></i></a>
    ...
    <script type='text/javascript' src='assets/js/pages/rh03_listanegra_listado.js'></script>
  </body>
</html>
