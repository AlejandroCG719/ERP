...
<html lang="es-MX">
  ...
  <body class="">
        ...
        <div id='wrap'>
          <div id="page-heading">
            <ol class="breadcrumb">
              ...
              <li class="active">Listado de Relación</li>
            </ol>
            <h1><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Personal/Promoción</h1>
            <div class="options">
              ...
              <div class="col-md-12">
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadPersonalPromocion()">
                      Listado de relación
                    </h4>
                    <div class="options">
                      <a href="javascript:;"><i class="fa fa-cog"></i></a>
                      <a href="javascript:;" onclick="loadPersonalPromocion()"><i class="fa fa-refresh"></i></a>
    ...
    <script type='text/javascript' src='assets/js/pages/sysadm01_per_prom_listado.js'></script>
  </body>
</html>
