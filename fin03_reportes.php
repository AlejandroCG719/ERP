...
<html lang="es-MX">
  ...
  <body class="">
        ...
        <div id='wrap'>
          <div id="page-heading">
            <ol class="breadcrumb">
              ...
              <li><a href="fin02_ingresos_listado.php"><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Reportes</a></li>
              <li class="active">Listado de Reportes</li>
            </ol>
            <h1><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Reportes</h1>
          </div>
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadReportes()">
                      Listado de Reportes
                    </h4>
                    <div class="options">
                      <a href="javascript:;"><i class="fa fa-cog"></i></a>
                      <a href="javascript:;" onclick="loadReportes()"><i class="fa fa-refresh"></i></a>
    ...
    <script type='text/javascript' src='assets/js/pages/fin03_reportes.js'></script>
  </body>
</html>
