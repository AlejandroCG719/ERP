...
<html lang="es-MX">
  ...
  <body class="">
    ...
    <div id="page-container">
      ...
      <div id="page-content">
        <input type="hidden" id='id_perfil' value="<?= $_GET['id_perfil']?>" />
        <div id='wrap'>
          <div id="page-heading">
            <ol class="breadcrumb">
              <li><a href="index.php"><i class="fa fa-home"></i> Inicio</a></li>
              <li><a href="cnfg02_perfil_listado.php"><i class="fa fa-user"></i> Perfiles</a></li>
              <li class="active"><i class="fa fa-unlock"></i> Accesos y Privilegios</li>
            </ol>
            <h1><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Perfiles</h1>
            <div class="options">
              <div class="btn-toolbar">
                ...
                <a href='cnfg05_catalogos_edicion.php?nombre_tabla=cat_perfiles' class="btn btn-default"><i class="fa fa-plus"></i><span class="hidden-sm"> Nuevo perfil</span></a>
              ...
              <div class="col-md-12">
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadAccesos()">
                      Listado de Módulos
                    </h4>
                    <div class="options">
                      <a href="javascript:;"><i class="fa fa-cog"></i></a>
                      <a onclick="loadAccesos()"><i class="fa fa-refresh"></i></a>
                      <a class="panel-collapse"><i class="fa fa-chevron-down"></i></a>
                    </div>
                  </div>
    ...
    <script type='text/javascript' src='assets/js/pages/cnfg02_perfil_accesos.js'></script>
  </body>
</html>
