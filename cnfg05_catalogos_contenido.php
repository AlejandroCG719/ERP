...
<html lang="es-MX">
  ...
  <body class="">
          ...
          <div id="page-heading">
            ...
            <div class="options">
              <div class="btn-toolbar">
                ...
                <a href='cnfg05_catalogos_edicion.php?nombre_tabla=<?=$_REQUEST['nombre_tabla'] ?>' class="btn btn-default" id="btn-nuevo" disabled><i class="fa fa-plus"></i><span class="hidden-sm"> Nuevo registro</span></a>
              </div>
            </div>
          </div>
          <div class="container">
                ...
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadCatalogos()">
                      Catálogos - <?= $_REQUEST['nombre_tabla'] ?>
                    </h4>
                    <div class="options">
                  ...
                  <input type="hidden" id="nombre_tabla" value="<?= $_REQUEST['nombre_tabla'] ?>"/>
    ...
    <script type='text/javascript' src='assets/js/pages/cnfg05_catalogos_contenido.js'></script>
  </body>
</html>
