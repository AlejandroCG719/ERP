...
<html lang="es-MX">
  ...
  <body class="">
        ...
        <div id='wrap'>
          <div id="page-heading">
            <ol class="breadcrumb">
              ...
              <li><a href="#"><i class="<?= $oBreadcrumb->getImagen() ?>"></i> Accesos y Privilegios</a></li>
              ...
              <div class="col-md-12">
                <div class="panel panel-sky">
                  <div class="panel-heading">
                    <h4 onclick="loadPerfiles()">
                      Seleccione un perfil para editar
                    </h4>
                    <div class="options">
                      <a href="javascript:;"><i class="fa fa-cog"></i></a>
                      <a href="javascript:;" onclick="loadPerfiles()"><i class="fa fa-refresh"></i></a>
    ...
    <script type='text/javascript' src='assets/js/pages/cnfg02_perfil_listado.js'></script>
  </body>
</html>
