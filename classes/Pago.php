...
class Pago{
  ...
  public function getProgramacionPago() {
  ...
  public function setFechaDeposito($programacion_pago) {
    $this->programacion_pago = $programacion_pago;
  }
  ...
  public function setConsulta($id){
    ...
    while($row= mysqli_fetch_assoc($query)){
      ...
      $this->programacion_pago = $row['programacion_pago'];
